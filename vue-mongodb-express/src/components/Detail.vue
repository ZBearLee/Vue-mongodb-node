    ...
    <div>
      ...
      <div class="detail" v-else>
        ...
        <div class="detail-right">
            ...
            <p class="movie-akas">别名:<span class="movie-aka" 
              v-for="aka of movie.aka">{{aka}}</span></p>
            <p class="movie-genres">
              {{movie.countries.join('')}} ({{movie.year}})
              <span  class="movie-genre" v-for="genre of movie.genres">{{genre}}</span>
              评分: {{movie.rating.average}}
            </p>
            <p class="movie-directors">导演:<a :href="dir.alt" 
              v-for="dir of movie.directors">{{dir.name}}</a></p>
